...
with st.sidebar:
    ...
    st.markdown(
        ...
        '<div class="about-row"><span class="about-label">AI Chatbot Developed by</span>'
        '<span class="about-value">Nikita Chougule — Cloud DevOps Engineer</span></div>'
        '<div class="about-row"><span class="about-label">Medical Content Support by</span>'
        '<span class="about-value">Mayur Deokar — Senior Radiation Therapist</span></div>'
        '</div>',
        unsafe_allow_html=True,
    )
